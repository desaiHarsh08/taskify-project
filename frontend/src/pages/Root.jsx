...
const Root = () => {
    ...
    return (
        <main className="border border-red-500 overflow-hidden h-screen flex justify-center items-center absolute inset-0 -z-10 w-full bg-white bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:6rem_4rem]">
                ...
                <div className="flex flex-col w-full sm:w-3/4 items-center py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
                    ...
                    <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form onSubmit={handleLoginSubmit} className="space-y-4 md:space-y-3" action="#">
